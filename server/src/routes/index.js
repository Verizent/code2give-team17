...
// to them (a sub-router with no matching route calls next()), but reading it last
// matches the order requests actually resolve in.
//
// It arrived from the donations track with NO guard at all and a comment deferring auth
// to merge time. That covered nine endpoints including GET /api/admin/donors, which

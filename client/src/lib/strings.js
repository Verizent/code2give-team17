...
export const STRINGS = {
  en: {
    ...
    hero: {
      ...
      liveUpdated: 'last updated {n}s ago',
      reportNote: '· annual report 2024/25',
    },
    stats: {
    ...
    admin: {
      ...
      navModerationHint: 'Stories and Instagram',
  ...
  'zh-Hant': {
    ...
    admin: {
      ...
      navModeration: '社群',
      navModerationHint: '故事與 Instagram',
      navAnalytics: '數據分析',
  ...
  'zh-Hans': {
    ...
    admin: {
      ...
      navModeration: '社群',
      navModerationHint: '故事与 Instagram',
      navAnalytics: '数据分析',

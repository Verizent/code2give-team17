...
export const STRINGS = {
  en: {
    ...
    community: {
      ...
      shareHint: 'Share a real moment in your own words — a sentence or two is plenty.',
...
volunteer: {
  ...
  'zh-Hant': {
    ...
    community: {
      ...
      shareCta: '分享一個時刻',
      shareTitle: '分享一個時刻',
      shareHint: '用自己的話分享一個真實時刻——一兩句話就足夠。',
      shareAsLabel: '以此身分發佈',
      sharePhoto: '照片',
      shareLine: '你的故事',
...
volunteer: {
  ...
  'zh-Hans': {
    ...
    community: {
      ...
      shareCta: '分享一个时刻',
      shareTitle: '分享一个时刻',
      shareHint: '用自己的话分享一个真实时刻——一两句话就足够。',
      shareAsLabel: '以此身份发布',
      sharePhoto: '照片',
      shareLine: '你的故事',

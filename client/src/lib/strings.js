...
export const STRINGS = {
  en: {
    ...
    articlesPage: {
      ...
      inPress: 'Elsewhere in the media',
      inPressLede: 'Coverage we cannot republish, so these open on the original site.',

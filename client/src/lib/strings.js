...
export const STRINGS = {
  en: {
    ...
    community: {
      ...
      voicesTitle: 'In their own words',
      voicesIntro: 'Stories supporters sent us, published after a quick check by our team.',
      ...
      knowledgeHook: "Want to volunteer? Here's the link",
    ...
    volunteer: {
      ...
      verifyBody:
        'We sent a 6-digit code to {email}. Enter it to confirm the address is yours.',
      verifyCodeLabel: 'Verification code',
      verifyConfirm: 'Confirm and join',
      verifyResend: 'Send a new code',
      verifyBadCode:
        'That code is not right, or it has expired. Check your email and try again.',
      verifySendError: 'We could not send the code. Please try again.',
      verifyRateLimited:
        'Too many code requests for this address. Wait a few minutes and try again.',
      discoveryTitle: 'How did you hear about Love 21?',
      discoveryHint: 'Optional — choose as many as apply.',
      discoveryOther: 'Tell us where',
      discoverySources: {
        instagram: 'Instagram',
        facebook: 'Facebook',
        ...
        time_auction: 'Time Auction',
        search: 'Search engine',
        love21_site: 'Love 21 website',
        event: 'An event',
        other: 'Other',
      },
    ...
    give: {
      ...
      customAmountHint: 'Every dollar counts — type any amount from HK$4.',
      amountInvalid: 'Enter a whole gift amount of at least HK$4.',
      amountTooLarge:
        'Online gifts are capped at HK$1,000,000. For a larger gift, contact Maggie@love21foundation.com.',
      ...
      applyCustom: 'Apply',
      journeyOptInLabel: 'Email me updates on where this gift goes',
      journeyOptInHelper:
        'A round-up on the 15th and at month end, covering the sessions your gift funded. Gift-use updates only — not a newsletter.',
      referralLabel: 'How did you hear about Love 21?',
      referralHelper: 'Optional — choose any that apply. We ask once, and it helps us know what works.',
      referralOtherPlaceholder: 'Tell us where (optional)',
      referralSources: {
        friend_family: 'Friend or family',
        social: 'Social media',
        edm: 'Newsletter / EDM',
        company: 'Employer / CSR',
        event: 'An event',
      ...
      thanksConfirming: 'Confirming your payment with Stripe…',
      thanksConfirmSlow:
        'Your payment went through. The confirmation is taking longer than usual — refresh this page in a moment.',
      thanksConfirmFailed: 'That payment did not complete. No money was taken.',
      thanksCreditedOne: 'Your gift supports the next session Love 21 runs.',
      thanksCreditedMany: 'Your gift supports the next {count} sessions Love 21 runs.',
      thanksTrackCta: 'See the sessions you supported',
      trackKicker: 'Your giving',
      trackTitle: 'The sessions your gifts support',
      trackSupporterSince: 'Supporting Love 21 since {date}',
      trackNotFound:
        'That tracking link is not valid. Check the link in your email, or ask us for a new one.',
      trackLoading: 'Loading your giving…',
      trackTotalGiven: 'Given in total',
      trackDonationCount: 'Gifts',
      trackSessionsSupported: 'Sessions completed',
      trackSessionsOnTheWay: 'Sessions on the way',
      trackPeopleReached: 'Members reached',
      trackCurrentEdition: 'This update',
      trackCredited: '{count} sessions credited',
      trackNoEvents: 'No sessions matched to your gift yet — they appear as they are scheduled.',
      trackArchive: 'Earlier updates',
      trackNextUpdate: 'Next update {date}',
      trackUpdateSent: 'Sent {date}',
      trackExpected: '{count} members expected',
      trackAttended: '{count} came along',
      trackStatusScheduled: 'Scheduled',
    ...
    admin: {
      ...
      igCaptionLabel: 'Caption (optional)',
      igOrderLabel: 'Order',
      igAdd: 'Add post',
      igEmpty: 'No posts pinned yet.',
      igActive: 'Showing',
      igHidden: 'Hidden',
      igRemove: 'Remove',
      igConfirmRemove: 'Confirm remove',
      igCancel: 'Cancel',
      igError: 'Could not load Instagram posts.',
      kicker: 'Staff',
      hubTitle: 'Staff hub',
      ...
      navModeration: 'Community',
      navModerationHint: 'Voices submissions',
      navInstagram: 'Instagram',
      navInstagramHint: 'Pinned posts',
      navWishlist: 'Wishlist',
      navWishlistHint: 'Items supporters can pledge',
      navVolunteers: 'Volunteers',
      navVolunteersHint: 'Who signed up for each session',
      navAnalytics: 'Analytics',
      navAnalyticsHint: 'Supporter and programme trends',
      analyticsTitle: 'Analytics',
      analyticsIntro: 'Supporter retention, programme demand and where people find us.',
      analyticsIllustrative:
        'Illustrative data — these figures come from a demo seed, not real supporter activity.',
      analyticsNoData: 'Not enough data yet',
      analyticsLoadError: 'Could not load analytics.',
      analyticsDonorRetention: 'Donor retention',
      analyticsDonorRetentionHint: 'Gave again this year after giving last year. Sector average 40–45%.',
      analyticsRepeatGift: 'Repeat giving',
      analyticsRepeatGiftHint: 'Donors who have given more than once.',
      analyticsCapacityFill: 'Capacity filled',
      analyticsCapacityFillHint: 'Attendance against places offered across all sessions.',
      analyticsSatisfaction: 'Volunteer satisfaction',
      analyticsSatisfactionHint: 'Average rating out of 5, from volunteers who left feedback.',
      analyticsWouldReturn: 'would volunteer again',
      analyticsResponses: 'responses',
      analyticsProgrammes: 'Programme demand',
      analyticsProgrammesIntro:
        'Places offered against people who came. A wide gap means demand is not converting to attendance.',
      analyticsCapacityLabel: 'Places offered',
      analyticsAttendedLabel: 'Attended',
      analyticsSource: 'Where did you find us',
      analyticsSourceIntro: 'Self-reported by donors and volunteers when they first joined.',
      analyticsSourceDonors: 'Donors',
      analyticsSourceVolunteers: 'Volunteers',
      analyticsSourcePending: 'Awaiting the source column migration — showing placeholder counts.',
      hubToday: 'Today',
      hubTodayIntro: 'Open items waiting on staff right now.',
      hubQueueEmpty: 'Nothing waiting — the queue is clear.',
      hubLive: 'Live figures',
      hubLiveIntro: 'Counted from the database as it stands.',
      hubIllustrative: 'Analytics',
      hubVolunteerGroup: 'Volunteer programmes',
      hubVolunteerGroupIntro:
        'Real figures, counted from recorded signups and attendance in the database.',
      hubGivingGroup: 'Giving — illustrative figures',
      hubIllustrativeIntro:
        'The giving figures below are generated demo data, not real supporter activity. Volunteer figures are real.',
      ...
      hubRangeLegend: 'Time range',
      hubRangeAll: 'All time',
      hubRange1y: '1 year',
      hubRange6m: '6 months',
      hubRange3m: '3 months',
      hubRange1m: '1 month',
      analyticsSignedUpLabel: 'Signed up',
      analyticsRetentionWindow: '{n} of {m} donors who gave {prior} gave again {current}',
      ...
      volunteersIntro: 'Open a session to see who signed up for it.',
      volunteersShowPast: 'Show past sessions',
      volunteersHidePast: 'Hide past sessions',
      volunteersPastHeading: 'Past sessions',
      volunteersEmpty: 'No volunteer sessions yet.',
      volunteersTruncated: 'Showing the 50 most recent sessions.',
      volunteersLoadError: 'Could not load volunteer sessions.',
      volunteersRosterError: 'Could not load this roster.',
      volunteersRosterEmpty: 'No one has signed up yet.',
      volunteersRosterLoading: 'Loading roster…',
      volunteersColName: 'Name',
      volunteersColEmail: 'Email',
      volunteersColStatus: 'Status',
      volunteersColSignedUp: 'Signed up',
      volunteersStatAttended: 'Attended',
      volunteersStatNoShow: 'No-shows',
      volunteersStatRating: 'Average rating',
      volunteersStatReturn: 'Would return',
      volunteersStatResponses: 'Feedback in',
      volunteersNoName: 'No name given',
      volunteersCount: '{count} of {capacity}',
      volunteersNewButton: 'New opportunity',
      volunteersNewTitle: 'New volunteer opportunity',
      volunteersNewIntro:
        'Creating this also creates the linked session, so donations can be allocated to it.',
      volunteersFieldTitleEn: 'Title (English)',
      volunteersFieldTitleZh: 'Title (繁體中文)',
      volunteersFieldLocationEn: 'Location (English)',
      volunteersFieldLocationZh: 'Location (繁體中文)',
      volunteersFieldDescriptionEn: 'Description (English)',
      volunteersFieldDescriptionZh: 'Description (繁體中文)',
      volunteersFieldProgramme: 'Programme',
      volunteersFieldCapacity: 'Capacity',
      volunteersFieldStarts: 'Starts',
      volunteersFieldEnds: 'Ends',
      volunteersFieldMinAge: 'Minimum age (optional)',
      volunteersFieldSkills: 'Skills (optional, comma separated)',
      volunteersSubmit: 'Create',
      volunteersSubmitting: 'Creating…',
      volunteersCancel: 'Cancel',
      volunteersCreated: 'Created "{title}" and its linked session.',
      volunteersErrRequired: 'Fill in every field in both languages.',
      volunteersErrCapacity: 'Capacity must be a whole number between 1 and 1000.',
      volunteersErrMinAge: 'Minimum age must be between 0 and 120.',
      volunteersErrDates: 'Both a start and an end time are needed.',
      volunteersErrOrder: 'The end time must be after the start time.',
      volunteersCreateError: 'Could not create the opportunity.',
      ...
      dashboardPendingHint: 'Fundraisers and Voices awaiting review',
  ...
  'zh-Hant': {
    ...
    community: {
      instagramTitle: '我們的 Instagram',
      instagramOpen: '在 Instagram 開啟',
      voicesTitle: '他們的心聲',
      voicesIntro: '支持者寄來的故事，經團隊查核後刊登。',
      eyebrow: '社群 · 實證與認識',
      title: '能力，早已盛大。',
      subhead:
    ...
    volunteer: {
      ...
      verifyTitle: '請查看電郵',
      verifyBody: '我們已將 6 位數字驗證碼寄至 {email}，請輸入以確認此電郵屬於你。',
      verifyCodeLabel: '驗證碼',
      verifyConfirm: '確認並報名',
      verifyResend: '重新寄送驗證碼',
      verifyBadCode: '驗證碼不正確或已過期，請查看電郵後再試。',
      verifySendError: '未能寄出驗證碼，請再試。',
      verifyRateLimited: '此電郵索取驗證碼次數過多，請稍候幾分鐘再試。',
      discoveryTitle: '你從哪裡認識 Love 21？',
      discoveryHint: '可選——可以多選。',
      discoveryOther: '請告訴我們',
      discoverySources: {
        instagram: 'Instagram',
        facebook: 'Facebook',
        word_of_mouth: '朋友介紹',
    ...
    give: {
      ...
      customAmountHint: '每一元都有意義 — 可由港幣 4 元起。',
      amountInvalid: '請輸入至少港幣 4 元的整數金額。',
      amountTooLarge:
        '網上捐款上限為港幣 1,000,000 元。如需捐出更多，請聯絡 Maggie@love21foundation.com。',
      ...
      journeyOptInHelper:
        '每月 15 日及月底各一次總結，說明你的捐款支持了哪些課堂。只限捐款用途更新，不是通訊。',
      referralLabel: '你從何得知 Love 21？',
      referralHelper: '選填 — 可選多項。我們只會問一次，這有助我們了解成效。',
      referralOtherPlaceholder: '請告訴我們（選填）',
      referralSources: {
        friend_family: '親友介紹',
        social: '社交媒體',
        edm: '電子通訊',
      ...
      thanksConfirming: '正在與 Stripe 確認你的付款⋯',
      thanksConfirmSlow: '付款已完成。確認需時較長，請稍後重新整理此頁面。',
      thanksConfirmFailed: '該筆付款未能完成，並未扣款。',
      thanksCreditedOne: '你的捐助支持 Love 21 舉辦的下一節活動。',
      thanksCreditedMany: '你的捐助支持 Love 21 舉辦的下 {count} 節活動。',
      thanksTrackCta: '查看你支持的活動',
      trackKicker: '你的捐助',
      trackTitle: '你的捐助支持的活動',
      trackSupporterSince: '自 {date} 起支持 Love 21',
      trackNotFound: '此追蹤連結無效。請檢查電郵中的連結，或聯絡我們重新發送。',
      trackLoading: '正在載入你的捐助紀錄⋯',
      trackTotalGiven: '累計捐助',
      trackDonationCount: '捐助次數',
      trackSessionsSupported: '已完成的活動',
      trackSessionsOnTheWay: '即將舉行的活動',
      trackPeopleReached: '受惠成員',
      trackCurrentEdition: '本次更新',
      trackCredited: '已分配 {count} 節活動',
      trackNoEvents: '尚未配對到活動 — 活動編定後便會顯示。',
      trackArchive: '過往更新',
      trackNextUpdate: '下次更新 {date}',
      trackUpdateSent: '已於 {date} 發送',
      trackExpected: '預計 {count} 位成員參加',
      trackAttended: '{count} 位成員參加了',
      trackStatusScheduled: '已編定',
      trackStatusCompleted: '已完成',
      trackStatusCancelled: '已取消',
    },
    login: {
      kicker: '歡迎回來',
      signInTitle: '登入',
    ...
    admin: {
      ...
      igHidden: '已隱藏',
      igRemove: '移除',
      igConfirmRemove: '確認移除',
      igCancel: '取消',
      igError: '無法載入 Instagram 貼文。',
      kicker: '職員',
      hubTitle: '職員中心',
      accessDenied: '無法存取',
      accessDeniedBody:
      ...
      navModeration: '社群',
      navModerationHint: '社群投稿',
      navInstagram: 'Instagram',
      navInstagramHint: '置頂貼文',
      navWishlist: '心願清單',
      navWishlistHint: '支持者可認捐的物資',
      navVolunteers: '義工',
      navVolunteersHint: '各節活動的報名名單',
      navAnalytics: '數據分析',
      navAnalyticsHint: '支持者與計劃趨勢',
      analyticsTitle: '數據分析',
      analyticsIntro: '支持者留存、計劃需求，以及大家從何得知我們。',
      analyticsIllustrative: '示範數據 — 這些數字來自示範資料，並非真實的支持者活動。',
      analyticsNoData: '數據尚未足夠',
      analyticsLoadError: '無法載入數據分析。',
      analyticsDonorRetention: '捐款者留存率',
      analyticsDonorRetentionHint: '去年捐款後今年再次捐款的比例。業界平均為 40–45%。',
      analyticsRepeatGift: '重複捐款',
      analyticsRepeatGiftHint: '捐款超過一次的捐款者。',
      analyticsCapacityFill: '名額使用率',
      analyticsCapacityFillHint: '所有活動的出席人數相對於提供名額。',
      analyticsSatisfaction: '義工滿意度',
      analyticsSatisfactionHint: '曾留下意見的義工評分，滿分 5 分。',
      analyticsWouldReturn: '願意再次參與',
      analyticsResponses: '份回覆',
      analyticsProgrammes: '計劃需求',
      analyticsProgrammesIntro: '提供名額與實際出席人數的對比。差距愈大，代表報名未能轉化為出席。',
      analyticsCapacityLabel: '提供名額',
      analyticsAttendedLabel: '實際出席',
      analyticsSource: '從何得知我們',
      analyticsSourceIntro: '由捐款者及義工首次加入時自行填報。',
      analyticsSourceDonors: '捐款者',
      analyticsSourceVolunteers: '義工',
      analyticsSourcePending: '等待 source 欄位遷移 — 現時顯示佔位數字。',
      hubToday: '今日',
      hubTodayIntro: '目前等待職員處理的項目。',
      hubQueueEmpty: '沒有待辦項目。',
      hubLive: '實際數據',
      hubLiveIntro: '直接取自現時的資料庫。',
      hubIllustrative: '數據分析',
      hubVolunteerGroup: '義工計劃',
      hubVolunteerGroupIntro: '真實數據，取自資料庫中已記錄的報名與出席。',
      hubGivingGroup: '捐款 — 示範數據',
      hubIllustrativeIntro: '以下捐款數據為示範數據，並非真實的支持者活動。義工數據為真實數據。',
      hubChartMoney: '捐款金額',
      ...
      hubRange3m: '三個月',
      hubRange1m: '一個月',
      analyticsSignedUpLabel: '已報名',
      analyticsRetentionWindow: '{prior} 曾捐款的 {m} 位捐款者中，有 {n} 位在 {current} 再次捐款',
      storiesTitle: '故事台',
      storiesIntro:
      ...
      articlesDeleted: '文章已刪除。',
      articlesSave: '儲存',
      articlesPublish: '發佈',
      articlesUnpublish: '取消發佈',
      articlesDelete: '刪除',
      articlesConfirmDelete: '確認刪除',
      articlesCancel: '取消',
      ...
      volunteersTitle: '義工',
      volunteersIntro: '展開任何一節活動，即可查看報名的義工。',
      volunteersShowPast: '顯示過往活動',
      volunteersHidePast: '隱藏過往活動',
      volunteersPastHeading: '過往活動',
      volunteersEmpty: '暫時未有義工活動。',
      volunteersTruncated: '僅顯示最近 50 節活動。',
      volunteersLoadError: '無法載入義工活動。',
      volunteersRosterError: '無法載入此名單。',
      volunteersRosterEmpty: '暫時未有人報名。',
      volunteersRosterLoading: '正在載入名單…',
      volunteersColName: '姓名',
      volunteersColEmail: '電郵',
      volunteersColStatus: '狀態',
      volunteersColSignedUp: '報名日期',
      volunteersStatAttended: '出席',
      volunteersStatNoShow: '缺席',
      volunteersStatRating: '平均評分',
      volunteersStatReturn: '願意再參與',
      volunteersStatResponses: '已收回饋',
      volunteersNoName: '未提供姓名',
      volunteersCount: '{count} / {capacity}',
      volunteersNewButton: '新增義工機會',
      volunteersNewTitle: '新增義工機會',
      volunteersNewIntro: '建立時會同時建立相連的活動，捐款便可分配到該活動。',
      volunteersFieldTitleEn: '名稱（English）',
      volunteersFieldTitleZh: '名稱（繁體中文）',
      volunteersFieldLocationEn: '地點（English）',
      volunteersFieldLocationZh: '地點（繁體中文）',
      volunteersFieldDescriptionEn: '描述（English）',
      volunteersFieldDescriptionZh: '描述（繁體中文）',
      volunteersFieldProgramme: '計劃',
      volunteersFieldCapacity: '名額',
      volunteersFieldStarts: '開始時間',
      volunteersFieldEnds: '結束時間',
      volunteersFieldMinAge: '最低年齡（可選）',
      volunteersFieldSkills: '技能（可選，以逗號分隔）',
      volunteersSubmit: '建立',
      volunteersSubmitting: '建立中…',
      volunteersCancel: '取消',
      volunteersCreated: '已建立「{title}」及其相連活動。',
      volunteersErrRequired: '請以兩種語言填寫所有欄位。',
      volunteersErrCapacity: '名額須為 1 至 1000 的整數。',
      volunteersErrMinAge: '最低年齡須介乎 0 至 120。',
      volunteersErrDates: '請填寫開始及結束時間。',
      volunteersErrOrder: '結束時間必須在開始時間之後。',
      volunteersCreateError: '無法建立義工機會。',
      campaignsTitle: '籌款',
      ...
      dashboardPendingHint: '待審核的籌款與聲音',
  ...
  'zh-Hans': {
    ...
    community: {
      instagramTitle: '我们的 Instagram',
      instagramOpen: '在 Instagram 打开',
      voicesTitle: '他们的心声',
      voicesIntro: '支持者寄来的故事，经团队查核后刊登。',
      eyebrow: '社群 · 实证与认识',
      title: '能力，早已盛大。',
      subhead:
    ...
    volunteer: {
      ...
      verifyTitle: '请查看电邮',
      verifyBody: '我们已将 6 位数字验证码寄至 {email}，请输入以确认此电邮属于你。',
      verifyCodeLabel: '验证码',
      verifyConfirm: '确认并报名',
      verifyResend: '重新发送验证码',
      verifyBadCode: '验证码不正确或已过期，请查看电邮后再试。',
      verifySendError: '未能发送验证码，请再试。',
      verifyRateLimited: '此电邮索取验证码次数过多，请稍候几分钟再试。',
      discoveryTitle: '你从哪里认识 Love 21？',
      discoveryHint: '可选——可以多选。',
      discoveryOther: '请告诉我们',
      discoverySources: {
        instagram: 'Instagram',
        facebook: 'Facebook',
        word_of_mouth: '朋友介绍',
    ...
    give: {
      ...
      customAmountHint: '每一元都有意义 — 可由港币 4 元起。',
      amountInvalid: '请输入至少港币 4 元的整数金额。',
      amountTooLarge:
        '网上捐款上限为港币 1,000,000 元。如需捐出更多，请联络 Maggie@love21foundation.com。',
      ...
      journeyOptInHelper:
        '每月 15 日及月底各一次总结，说明你的捐款支持了哪些课堂。只限捐款用途更新，不是通讯。',
      referralLabel: '你从何得知 Love 21？',
      referralHelper: '选填 — 可选多项。我们只会问一次，这有助我们了解成效。',
      referralOtherPlaceholder: '请告诉我们（选填）',
      referralSources: {
        friend_family: '亲友介绍',
        social: '社交媒体',
        edm: '电子通讯',
      ...
      thanksConfirming: '正在与 Stripe 确认你的付款⋯',
      thanksConfirmSlow: '付款已完成。确认需时较长，请稍后刷新此页面。',
      thanksConfirmFailed: '该笔付款未能完成，并未扣款。',
      thanksCreditedOne: '你的捐助支持 Love 21 举办的下一节活动。',
      thanksCreditedMany: '你的捐助支持 Love 21 举办的下 {count} 节活动。',
      thanksTrackCta: '查看你支持的活动',
      trackKicker: '你的捐助',
      trackTitle: '你的捐助支持的活动',
      trackSupporterSince: '自 {date} 起支持 Love 21',
      trackNotFound: '此追踪链接无效。请检查电邮中的链接，或联系我们重新发送。',
      trackLoading: '正在载入你的捐助记录⋯',
      trackTotalGiven: '累计捐助',
      trackDonationCount: '捐助次数',
      trackSessionsSupported: '已完成的活动',
      trackSessionsOnTheWay: '即将举行的活动',
      trackPeopleReached: '受惠成员',
      trackCurrentEdition: '本次更新',
      trackCredited: '已分配 {count} 节活动',
      trackNoEvents: '尚未配对到活动 — 活动编定后便会显示。',
      trackArchive: '过往更新',
      trackNextUpdate: '下次更新 {date}',
      trackUpdateSent: '已于 {date} 发送',
      trackExpected: '预计 {count} 位成员参加',
      trackAttended: '{count} 位成员参加了',
      trackStatusScheduled: '已编定',
      trackStatusCompleted: '已完成',
      trackStatusCancelled: '已取消',
    },
    login: {
    ...
    admin: {
      ...
      igHidden: '已隐藏',
      igRemove: '移除',
      igConfirmRemove: '确认移除',
      igCancel: '取消',
      igError: '无法载入 Instagram 贴文。',
      kicker: '职员',
      hubTitle: '职员中心',
      accessDenied: '无法访问',
      accessDeniedBody:
      ...
      navModerationHint: '社群投稿',
      navInstagram: 'Instagram',
      navInstagramHint: '置顶帖子',
      navWishlist: '心愿清单',
      navWishlistHint: '支持者可认捐的物资',
      navVolunteers: '义工',
      navVolunteersHint: '各节活动的报名名单',
      navAnalytics: '数据分析',
      navAnalyticsHint: '支持者与计划趋势',
      analyticsTitle: '数据分析',
      analyticsIntro: '支持者留存、计划需求，以及大家从何得知我们。',
      analyticsIllustrative: '示范数据 — 这些数字来自示范资料，并非真实的支持者活动。',
      analyticsNoData: '数据尚未足够',
      analyticsLoadError: '无法载入数据分析。',
      analyticsDonorRetention: '捐款者留存率',
      analyticsDonorRetentionHint: '去年捐款后今年再次捐款的比例。业界平均为 40–45%。',
      analyticsRepeatGift: '重复捐款',
      analyticsRepeatGiftHint: '捐款超过一次的捐款者。',
      analyticsCapacityFill: '名额使用率',
      analyticsCapacityFillHint: '所有活动的出席人数相对于提供名额。',
      analyticsSatisfaction: '义工满意度',
      analyticsSatisfactionHint: '曾留下意见的义工评分，满分 5 分。',
      analyticsWouldReturn: '愿意再次参与',
      analyticsResponses: '份回复',
      analyticsProgrammes: '计划需求',
      analyticsProgrammesIntro: '提供名额与实际出席人数的对比。差距愈大，代表报名未能转化为出席。',
      analyticsCapacityLabel: '提供名额',
      analyticsAttendedLabel: '实际出席',
      analyticsSource: '从何得知我们',
      analyticsSourceIntro: '由捐款者及义工首次加入时自行填报。',
      analyticsSourceDonors: '捐款者',
      analyticsSourceVolunteers: '义工',
      analyticsSourcePending: '等待 source 栏位迁移 — 现时显示占位数字。',
      hubToday: '今日',
      hubTodayIntro: '目前等待职员处理的项目。',
      hubQueueEmpty: '没有待办项目。',
      hubLive: '实际数据',
      hubLiveIntro: '直接取自现时的资料库。',
      hubIllustrative: '数据分析',
      hubVolunteerGroup: '义工计划',
      hubVolunteerGroupIntro: '真实数据，取自资料库中已记录的报名与出席。',
      hubGivingGroup: '捐款 — 示范数据',
      hubIllustrativeIntro: '以下捐款数据为示范数据，并非真实的支持者活动。义工数据为真实数据。',
      hubChartMoney: '捐款金额',
      ...
      articlesUnpublished: '已退回草稿。',
      articlesDeleted: '文章已删除。',
      articlesSave: '保存',
      articlesPublish: '发布',
      articlesUnpublish: '取消发布',
      articlesDelete: '删除',
      articlesConfirmDelete: '确认删除',
      articlesCancel: '取消',
      ...
      volunteersTitle: '义工',
      volunteersIntro: '展开任何一节活动，即可查看报名的义工。',
      volunteersShowPast: '显示过往活动',
      volunteersHidePast: '隐藏过往活动',
      volunteersPastHeading: '过往活动',
      volunteersEmpty: '暂时未有义工活动。',
      volunteersTruncated: '仅显示最近 50 节活动。',
      volunteersLoadError: '无法载入义工活动。',
      volunteersRosterError: '无法载入此名单。',
      volunteersRosterEmpty: '暂时未有人报名。',
      volunteersRosterLoading: '正在载入名单…',
      volunteersColName: '姓名',
      volunteersColEmail: '电邮',
      volunteersColStatus: '状态',
      volunteersColSignedUp: '报名日期',
      volunteersStatAttended: '出席',
      volunteersStatNoShow: '缺席',
      volunteersStatRating: '平均评分',
      volunteersStatReturn: '愿意再参与',
      volunteersStatResponses: '已收回馈',
      volunteersNoName: '未提供姓名',
      volunteersCount: '{count} / {capacity}',
      volunteersNewButton: '新增义工机会',
      volunteersNewTitle: '新增义工机会',
      volunteersNewIntro: '建立时会同时建立相连的活动，捐款便可分配到该活动。',
      volunteersFieldTitleEn: '名称（English）',
      volunteersFieldTitleZh: '名称（繁體中文）',
      volunteersFieldLocationEn: '地点（English）',
      volunteersFieldLocationZh: '地点（繁體中文）',
      volunteersFieldDescriptionEn: '描述（English）',
      volunteersFieldDescriptionZh: '描述（繁體中文）',
      volunteersFieldProgramme: '计划',
      volunteersFieldCapacity: '名额',
      volunteersFieldStarts: '开始时间',
      volunteersFieldEnds: '结束时间',
      volunteersFieldMinAge: '最低年龄（可选）',
      volunteersFieldSkills: '技能（可选，以逗号分隔）',
      volunteersSubmit: '建立',
      volunteersSubmitting: '建立中…',
      volunteersCancel: '取消',
      volunteersCreated: '已建立「{title}」及其相连活动。',
      volunteersErrRequired: '请以两种语言填写所有栏位。',
      volunteersErrCapacity: '名额须为 1 至 1000 的整数。',
      volunteersErrMinAge: '最低年龄须介乎 0 至 120。',
      volunteersErrDates: '请填写开始及结束时间。',
      volunteersErrOrder: '结束时间必须在开始时间之后。',
      volunteersCreateError: '无法建立义工机会。',
      campaignsTitle: '筹款',
      ...
      dashboardPendingHint: '待审核的筹款与声音',

...
type Strings = {
  ...
  give: {
    ...
    publicCampaigns: string
    noPublicCampaigns: string
...
volunteer: {
    ...
    give: {
      ...
      publicCampaigns: 'Live fundraisers',
      noPublicCampaigns: 'No live fundraisers yet — yours may be pending below.',
...
volunteer: {
    ...
    give: {
      ...
      publicCampaigns: '已上線籌款',
      noPublicCampaigns: '暫時沒有已上線籌款——你的可能仍在下方等候審批。',
...
volunteer: {
    ...
    give: {
      ...
      publicCampaigns: '已上线筹款',
      noPublicCampaigns: '暂时没有已上线筹款——你的可能仍在下方等候审批。',
